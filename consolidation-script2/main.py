...
COMPAT_HEADER = config['compat_header']
FEATURE_HEADER = config['feature_header']
PARTITION_HEADER = config["partition_header"]

FULL_KEY = COMPAT_HEADER + FEATURE_HEADER

#  #TODO: Generalize this, 
# # TODO: Add a partition parameter


consolidate(OUTPUT_CSV_PATH, FULL_CSV_PATH, COMPAT_HEADER, FULL_KEY, PARTITION_HEADER)
