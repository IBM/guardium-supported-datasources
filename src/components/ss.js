  ...
  render(){
    ...
    return [
      <tr key="main" onClick={this.toggleExpander} class="tablerow">
        <td class="datacell">
          <KeyboardArrowDownIcon id={"rotate" + this.state.expanded} />
        </td>
              ...
              <div className="uk-width-1-2" id="specifics-container">
                <table id="specifics">
                  ...
                  <tr>
                    ...
                    <td>
                      {user["UID Chain"] == "" ? "-" : user["UID Chain"]}{" "}
                    </td>
                  </tr>
                  <tr>
                    <td id="heading">Encrypted Traffic: </td>
                    <td>
                      {user["Encrypted traffic"] == ""
                        ? "-"
                        : user["Encrypted traffic"]}{" "}
                    </td>
                    ...
                    <td>
                      {user["Compression"] == "" ? "-" : user["Compression"]}{" "}
                    </td>
                  </tr>
                  <tr>
